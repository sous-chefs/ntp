...
describe 'ntp attributes' do
  ...
  describe 'on Debian-family platforms' do
    let(:chef_run) { ChefSpec::Runner.new(platform: 'ubuntu', version: '12.04').converge('ntp::default') }
  ...
  describe 'on the CentOS 5 platform' do
    let(:chef_run) { ChefSpec::Runner.new(platform: 'centos', version: '5.8').converge('ntp::default') }
  ...
  describe 'on the Windows platform' do
    let(:chef_run) { ChefSpec::Runner.new(platform: 'windows', version: '2008R2').converge('ntp::default') }
  ...
  describe 'on the FreeBSD platform' do
    let(:chef_run) { ChefSpec::Runner.new(platform: 'freebsd', version: '9.1').converge('ntp::default') }
